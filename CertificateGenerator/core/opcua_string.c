...
#define OPCUA_STRING_PARANOID_MEMORY    MWEB_CF_YES
...
*===========================================================================*/
OpcUa_StatusCode OpcUa_String_SafeAttachReadOnly(   /*  bi */ OpcUa_String*         a_pDestination,
...
#if OPCUA_STRING_PARANOID_MEMORY
